...
**TKTK: Describe cubs-slideshow here.**
...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=1Ecan0YTsZQZ65vZCwOAN5orOUEmp4LNzBYWIBzS5_pM#gid=0).
...
def read_my_google_doc():
    ...
    get_document('1Ecan0YTsZQZ65vZCwOAN5orOUEmp4LNzBYWIBzS5_pM', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/cubs_slideshow/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|cubs-slideshow|tweet|`location`||
|cubs-slideshow|facebook|`location`||
|cubs-slideshow|email|`location`||
|cubs-slideshow|new-comment||
|cubs-slideshow|open-share-discuss||
|cubs-slideshow|close-share-discuss||
|cubs-slideshow|summary-copied||
|cubs-slideshow|featured-tweet-action|`action`|
|cubs-slideshow|featured-facebook-action|`action`|
